...
let handler = async (m, { conn, args}) => {
    let txt = args.join` `
    	  ...
    	  if (txt.length > 25) return conn.reply (m.chat, 'max letters 25',m)
    textpro("https://textpro.me/3d-stone-cracked-cool-text-effect-1029.html", [`${txt}`])
.then(async (data) => {
let au = `${data}`
console.log(data)
